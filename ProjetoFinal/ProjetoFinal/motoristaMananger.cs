...
namespace ProjetoFinal
{
    public class MotoristaManager
    {
        ...
        public void Salvar(int? motoristaId = null)
        {
            ...
            // Validação Telefone - só números e tamanho
            ...
            if (_txtTelefone.Text.Length != 13)  // ajuste para o número correto de dígitos
            {
                MessageBox.Show("O campo Telefone deve conter o DDD e a região!", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                _txtTelefone.Focus();
                return;
            }

            // Validação CNH - só números e tamanho
            ...
            if (_txtCNH.Text.Length != 11)  // ajuste para o número correto de dígitos
            {
                MessageBox.Show("O campo CNH deve conter exatamente 11 dígitos!", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                _txtCNH.Focus();
                return;
            }
            ...
            try
            {
                using (var connection = new SQLiteConnection(_connectionString))
                {
                    ...
                    if (motoristaId == null)  // novo registro
                    {
